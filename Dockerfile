...
RUN apk update && apk upgrade &&pip install gunicorn -i https://mirrors.aliyun.com/pypi/simple && pip install -r requirements.txt -i https://mirrors.aliyun.com/pypi/simple && apk add ffmpeg
EXPOSE 8080
